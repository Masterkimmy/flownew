...
const coustomer = () => {
  return (
    <div>
      <div className="bg-green-950 h-[100vh] flex flex-col items-center justify-center gap-10">
        ...
        <h1 className="text-white font-bold text-[40px] pr-[31vw]">
          What our customers say
        </h1>
        <div className="flex gap-[2vw] border-b-2 border-white py-10">
          <div className="bg-green-500 flex flex-col items-center justify-center w-[20vw]  h-[37vh]  gap-[80px] p-5 rounded-xl">
            <h3 className="font-semibold w-[15vw]">
          ...
          <div className="bg-green-500 flex flex-col  justify-center w-[20vw]  h-[37vh]  gap-[80px] p-10 rounded-xl">
            <h3 className="font-semibold w-[15vw]">
          ...
          <div>
            <div className="bg-green-500 flex flex-col  justify-center w-[20vw]  h-[37vh]  gap-[58px] p-8 rounded-xl">
              <h3 className="font-semibold w-[15vw]">
      ...
      <div className='bg-white h-[60vh] flex flex-col items-center justify-center gap-5'>
        <h1 className='font-bold text-[40px] w-[40vw]'>
          Our commitment to green energy is paving the way for a cleaner,
          healthier planet.
        </h1>
        <button className='bg-green-950 rounded-2xl border-none text-white w-[8vw] h-8'>Get in touch</button>
      </div>
    </div>
  );
}
